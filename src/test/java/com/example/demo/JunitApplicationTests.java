...
class JunitApplicationTests {
	...
	public void secondTest() {
		...
		Mockito.when(jService.getUser()).thenReturn("users213");
		HttpEntity<String> h = new HttpEntity<String>(null, null);
		String sh = restTemplate.exchange("http://localhost:" + port + "/api/getUser", HttpMethod.GET, h, String.class)
				.getBody();
